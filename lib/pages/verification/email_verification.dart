...
class EmailVerification extends StatefulWidget {
  const EmailVerification({Key? key, required this.keyValue}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 32,),
              SmallText(text: 'Enter the verification sent to your email "example@mail.com".', color: CustomColor.appBlue, textAlign: TextAlign.center,),
              SizedBox(height: 64,),
              VerificationCode(
                length: 4,
